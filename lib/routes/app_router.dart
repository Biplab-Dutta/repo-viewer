...
import 'package:repo_viewer/features/github/repos/searched_repos/presentation/searched_repos_page.dart';
...
@MaterialAutoRouter(
  routes: [
    ...
    AutoRoute<bool>(page: SearchedReposPage, path: '/search'),
  ],
